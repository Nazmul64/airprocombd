...
<body>
    ...
    <section class="solution-hero">
        <h1>{{ $category->category_name }} Solutions</h1>
        <p>Explore our comprehensive range of {{ $category->category_name }} solutions designed to meet your specific needs</p>
    </section>
    ...
    <section class="solutions-grid">
        ...
        @else
            <div class="no-solutions">
                ...
                <p>Currently, there are no solutions available in this category. Please check back later.</p>
            </div>
        @endif
    </section>
