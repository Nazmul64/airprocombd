...
<body>
    ...
    <nav class="product-breadcrumb" aria-label="breadcrumb">
        ...
        <span>›</span>
        <a href="{{ route('category.wise.products', $subcategory->category->category_slug) }}">
    ...
    <section class="product-hero">
        <h1>{{ $subcategory->subcategory_name }} Products</h1>
        <p>Discover our specialized {{ $subcategory->subcategory_name }} products under {{ $subcategory->category->category_name }}</p>
    </section>
    ...
    <section class="products-grid">
                ...
                @foreach($products as $product)
                    <div class="product-card">
                        <div class="product-card-image">
                            ...
                            <span class="product-badge">{{ $subcategory->subcategory_name }}</span>
                        </div>
        ...
        @else
            <div class="no-products">
                ...
                <p>Currently, there are no products available in this subcategory. Please check back later.</p>
                <a href="{{ route('category.wise.products', $subcategory->category->category_slug) }}" class="product-view-more">
                    ← Back to {{ $subcategory->category->category_name }}
                </a>
            </div>
        @endif
    </section>
